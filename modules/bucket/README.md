# [Bucket](https://docs.aws.amazon.com/s3/)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_this"></a> [this](#module\_this) | terraform-aws-modules/s3-bucket/aws | 4.0.1 |
...
| <a name="input_name"></a> [name](#input\_name) | The name of the bucket. Will be prepended and appended with namespace data. | `string` | n/a | yes |
